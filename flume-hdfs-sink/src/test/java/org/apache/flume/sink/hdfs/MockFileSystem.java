...
public class MockFileSystem extends FileSystem {
    ...
    public MockFileSystem(FileSystem fs, int numberOfRetriesRequired, boolean closeSucceed) {
        this.fs = fs;
        this.numberOfRetriesRequired = numberOfRetriesRequired;
    ...
    public FSDataOutputStream append(Path arg0, int arg1, Progressable arg2) throws IOException {
        ...
        latestOutputStream = new MockFsDataOutputStream(fs.append(arg0, arg1, arg2), closeSucceed);
    ...
    public FSDataOutputStream create(
            Path arg0, FsPermission arg1, boolean arg2, int arg3, short arg4, long arg5, Progressable arg6)
            throws IOException {
    ...
    public boolean rename(Path arg0, Path arg1) throws IOException {
        ...
        logger.info("Attempting to Rename: '" + currentRenameAttempts + "' of '" + numberOfRetriesRequired + "'");
