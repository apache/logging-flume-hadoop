...
public class HiveDelimitedTextSerializer implements HiveEventSerializer {
    ...
    public void configure(Context context) {
        delimiter = parseDelimiterSpec(context.getString(SERIALIZER_DELIMITER, defaultDelimiter));
        String fieldNames = context.getString(SERIALIZER_FIELDNAMES);
        if (fieldNames == null) {
            throw new IllegalArgumentException("serializer.fieldnames is not specified " + "for serializer "
    ...
    private static Character parseSerdeSeparatorSpec(String separatorStr) {
        ...
        throw new IllegalArgumentException(
                "serializer.serdeSeparator spec is invalid " + "for " + ALIAS + " serializer ");
    }
}
