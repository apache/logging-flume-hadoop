...
public class TestHiveSink {
    ...
    public void testSingleWriter(boolean partitioned, String dbName, String tblName, Channel pChannel)
            throws Exception {
        int totalRecords = 4;
        int batchSize = 2;
    ...
    @Test
    public void testHeartBeat() throws EventDeliveryException, IOException {
        int batchSize = 2;
        int batchCount = 3;
    ...
    private void checkRecordCountInTable(int expectedCount, String db, String tbl) throws IOException {
