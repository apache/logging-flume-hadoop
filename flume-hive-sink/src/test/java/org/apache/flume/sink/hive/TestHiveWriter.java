...
public class TestHiveWriter {
    ...
    public void testInstantiate() throws Exception {
        ...
        HiveWriter writer =
                new HiveWriter(endPoint, 10, true, timeout, callTimeoutPool, "flumetest", serializer, sinkCounter);
    ...
    public void testTxnBatchConsumption() throws Exception {
        ...
        HiveWriter writer = new HiveWriter(
                endPoint, txnPerBatch, true, timeout, callTimeoutPool, "flumetest", serializer, sinkCounter);
    ...
    private void checkRecordCountInTable(int expectedCount) throws IOException {
    ...
    public void testInOrderWrite() throws Exception {
        ...
        HiveWriter writer =
                new HiveWriter(endPoint, 10, true, timeout, callTimeoutPool, "flumetest", serializer2, sinkCounter);
    ...
    public void testSecondWriterBeforeFirstCommits() throws Exception {
        ...
        HiveWriter writer1 =
                new HiveWriter(endPoint1, 10, true, timeout, callTimeoutPool, "flumetest", serializer, sinkCounter1);

        writeEvents(writer1, 3);

        HiveWriter writer2 =
                new HiveWriter(endPoint2, 10, true, timeout, callTimeoutPool, "flumetest", serializer, sinkCounter2);
