...
public class TestKeyedKuduOperationsProducer {
    ...
    private KuduTable createNewTable(String tableName) throws Exception {
        ...
        columns.add(
                new ColumnSchema.ColumnSchemaBuilder(SimpleKeyedKuduOperationsProducer.KEY_COLUMN_DEFAULT, Type.STRING)
                        .key(true)
                        .build());
        ...
        CreateTableOptions createOptions = new CreateTableOptions()
                .setRangePartitionColumns(ImmutableList.of(SimpleKeyedKuduOperationsProducer.KEY_COLUMN_DEFAULT))
                .setNumReplicas(1);
    ...
    public void testDuplicateRowsWithUpsert() throws Exception {
        ...
        Context ctx = new Context(ImmutableMap.of(
                KuduSinkConfigurationConstants.PRODUCER_PREFIX + SimpleKeyedKuduOperationsProducer.OPERATION_PROP,
                "upsert",
                KuduSinkConfigurationConstants.PRODUCER,
        ...
        for (int i = 0; i < numRows; i++) {
            ...
            e.setHeaders(
                    ImmutableMap.of(SimpleKeyedKuduOperationsProducer.KEY_COLUMN_DEFAULT, String.format("key %s", i)));
            events.add(e);
        }
