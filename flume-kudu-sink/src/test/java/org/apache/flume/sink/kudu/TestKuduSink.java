...
public class TestKuduSink {
    ...
    private KuduTable createNewTable(String tableName) throws Exception {
        ...
        CreateTableOptions createOptions = new CreateTableOptions()
                .setRangePartitionColumns(ImmutableList.of("payload"))
                .setNumReplicas(1);
    ...
    private void doTestDuplicateRows(boolean ignoreDuplicateRows) throws Exception {
        ...
        sinkContext.put(KuduSinkConfigurationConstants.IGNORE_DUPLICATE_ROWS, Boolean.toString(ignoreDuplicateRows));
