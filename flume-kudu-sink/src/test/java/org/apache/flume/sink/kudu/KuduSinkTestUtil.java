...
class KuduSinkTestUtil {
    ...
    private static KuduSink createSink(String tableName, KuduClient client, Context ctx, String masterAddresses) {
    ...
    static KuduSink createSecureSink(String tableName, String masterAddresses, String clusterRoot) {
        Context context = new Context();
        context.put(KuduSinkConfigurationConstants.KERBEROS_KEYTAB, clusterRoot + "/krb5kdc/test-user.keytab");
    ...
    static void processEventsCreatingSink(KuduClient syncClient, Context context, String tableName, List<Event> events)
